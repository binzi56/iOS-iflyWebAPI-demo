...
- (YYWebImageOperation *)requestImageWithURL:(NSURL *)url
    ...
    return [self requestImageWithURL:url options:options scale:[UIScreen mainScreen].scale qualityOfService:NSQualityOfServiceDefault progress:progress transform:transform completion:completion];
}
                                  ...
                                  completion:(YYWebImageCompletionBlock)completion
{
    ...
    if (operation) {
        if (NSQualityOfServiceDefault != qualityOfService) {
