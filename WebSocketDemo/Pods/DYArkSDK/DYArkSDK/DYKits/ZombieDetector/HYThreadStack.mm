...
void HYThreadStack::fetchCurrentStack()
{
...
string HYThreadStack::currentStackInfo()
{
...
size_t HYThreadStack::occupyMemorySize()
{
    return HY_SIZE_FOR_STACK_DEPTH(_depth) + sizeof(HYThreadStack);
}
